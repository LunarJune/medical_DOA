...
import xly.handle.apps.servlet_proxy.HDLServletRequest.ResponseType;
import xly.handle.apps.servlet_proxy.handlers.CIDRUtils;
...
import xly.handle.hdllib.trust.JwtClaimsSet;
import xly.handle.hdllib.trust.TrustException;
import xly.handle.server.MonitorDaemon;
import xly.handle.server.servletcontainer.HandleServerInterface;
import xly.handle.server.servletcontainer.servlets.BaseHandleRequestProcessingServlet;
...
import xly.handle.server.servletcontainer.support.PreAuthenticatedRequestProcessor;
...
public class HDLProxy extends HttpServlet {
    ...
    public void init() throws ServletException {
        handleServer = (xly.handle.server.servletcontainer.HandleServerInterface) getServletContext().getAttribute("xly.handle.server.HandleServer");
        loadSettings();
        if (handleServer != null) {
