...
package xly.handle.apps.simple;
...
public class HomeNA {
    ...
    public static void main(String argv[]) {
        if (argv.length < 6) {
            System.err.println("usage: java xly.handle.apps.simple.HomeNA <auth hdl> <auth index> <privkey> <server ip> <server tcp port> <NA handle1> [<NA handle2>...]");
            System.exit(-1);
        }
