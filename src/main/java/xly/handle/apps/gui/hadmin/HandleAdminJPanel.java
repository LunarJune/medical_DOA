...
package xly.handle.apps.gui.hadmin;

import xly.handle.apps.gui.jutil.*;
import xly.handle.apps.gui.jwidget.*;
...
public class HandleAdminJPanel extends JPanel implements ActionListener {
    ...
    //protected xly.handle.apps.gui.jwidget.DataListJPanel dataList;
