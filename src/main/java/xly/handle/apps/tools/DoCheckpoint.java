...
/*
  ...
  <pre>
  java xly.handle.apps.tools.DoCheckpoint [siteinfo] [admin-hdl] [admin-index] [keytype] [key]
  </pre>
...
public class DoCheckpoint {
    ...
    public static void printUsageAndExit() {
        System.err.println("java xly.handle.apps.tools.DoCheckpoint " + "[siteinfo] [admin-hdl] [admin-index] [keytype] [key]");
