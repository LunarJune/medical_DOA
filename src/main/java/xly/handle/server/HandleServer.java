...
import xly.handle.server.servletcontainer.support.PreAuthenticatedChallengeAnswerRequest;
import xly.handle.server.servletcontainer.support.PreAuthenticatedChallengeResponse;
import xly.handle.server.txnlog.*;
import xly.handle.util.AutoSelfSignedKeyManager;
import xly.handle.util.X509HSCertificateGenerator;
...
public class HandleServer extends AbstractServer implements HandleServerInterface, RequestProcessor {
    ...
    private AbstractResponse processRecursiveRequestAndAdaptResponse(AbstractRequest clonedReq, AbstractRequest origReq) throws HandleException {
        ...
        try {
            ...
            origReq.setNamespaceExactly(clonedReq.getNamespace());
