...
package xly.handle.server.bdbje;

import net.cnri.util.StreamTable;
import xly.handle.hdllib.*;
import xly.handle.server.*;
import xly.handle.server.bdbje.BDBJEHandleStorage.DBWrapper.DBIterator;
...
public final class BDBJEHandleStorage implements HandleStorage {
    ...
    public static final void main(String argv[]) throws Exception {
        String usage = "usage: java xly.handle.server.bdbje.BDBJEHandleStorage " + "<dbdir> (list <prefix> | get <handle> | test <hdlprefix>)";
