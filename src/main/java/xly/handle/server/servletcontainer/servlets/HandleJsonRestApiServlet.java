...
import xly.handle.hdllib.AddValueRequest;
import xly.handle.hdllib.AuthenticationInfo;
import xly.handle.hdllib.CreateHandleRequest;
...
import xly.handle.hdllib.RemoveValueRequest;
import xly.handle.hdllib.ResolutionRequest;
import xly.handle.hdllib.ResponseMessageCallback;
import xly.handle.hdllib.Util;
import xly.handle.server.servletcontainer.support.LoggingResponseMessageCallbackWrapper;
...
public class HandleJsonRestApiServlet extends BaseHandleRequestProcessingServlet {
    ...
    private AbstractRequest getCreateOrAddRequest(HttpServletRequest servletReq) throws Exception {
        ...
        JsonElement valuesJson = JsonParser.parseReader(servletReq.getReader());
        HandleValue[] values;
