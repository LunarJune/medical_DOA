...
public class StandardHandleAuthenticationFilter implements Filter {
    ...
    private xly.handle.server.servletcontainer.HandleServerInterface handleServer;

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        handleServer = (xly.handle.server.servletcontainer.HandleServerInterface) filterConfig.getServletContext().getAttribute("xly.handle.server.HandleServer");
    }
