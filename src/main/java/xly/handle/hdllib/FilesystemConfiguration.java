...
import xly.handle.apps.simple.LocalInfoConverter;
...
public class FilesystemConfiguration extends Configuration {
    ...
    FilesystemConfiguration() {
        ...
        try {
            String configDirName = System.getProperty("xly.handle.configDir");
    ...
    public static void configureResolverUsingKeys(HandleResolver resolver, StreamTable configTable) {
        ...
        resolver.traceMessages = configTable.getBoolean("trace_resolution") || configTable.getBoolean("trace_outgoing_messages");
