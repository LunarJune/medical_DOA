 ...
 * server.
 *
 * @deprecated Use {@link xly.handle.hdllib.trust.HandleRecordTrustVerifier} and allied classes
 */
@Deprecated
public class SecureResolver {
    ...
    public static void main(String argv[]) throws Exception {
        if (argv.length <= 0) {
            System.err.println("usage: java xly.handle.hdllib.SecureResolver <handle1> [<handle2>...]");
            return;
        }
