...
public class HandleRecordTrustVerifier {
    ...
    private static boolean valueNeedsSignature(String handle, HandleValue value) {
        ...
        if ("0.NA/0.NA".equalsIgnoreCase(handle) && (value.hasType(xly.handle.hdllib.HandleSignature.SIGNATURE_TYPE) || value.hasType(xly.handle.hdllib.HandleSignature.METADATA_TYPE))) return false;
        return true;
    }
